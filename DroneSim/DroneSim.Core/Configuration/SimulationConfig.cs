namespace DroneSim.Core.Configuration
{
    ...
    public static class SimulationConfig
    {
        ...
        public static double YMin { get; set; } = 0; //Ground level
        public static double YMax { get; set; } = 1000;
        ...
        public static double SeparationSpeedFactor { get; set; } = 0.2; //Contribution to separation vector on EACH UPDATE CYCLE. Higher values make drones separate faster.
        public static double MaxDroneSpeedLimit { get; set; } = 0; //Maximum drone speed units on EACH UPDATE. 0 Means no limit.
        public static double PerceptionFactor { get; set; } = 10; //How many times the "MinSeparationDistance" to define which drones are considered as neighbors. Low values can make drones get separated from the rest.


        //Simulation parameters
        public static double MinSeparationDistance { get; set; } = 5;   //Minimum distance between drones. It multiplies "PerceptionFactor".
